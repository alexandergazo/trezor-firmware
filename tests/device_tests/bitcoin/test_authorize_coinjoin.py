...
def test_sign_tx(client):
    ...
    payment_req = make_payment_request(
        ...
        hash_outputs=bytes.fromhex(
            "0a22a63762369c4e1b95ccf06a6f81be304e98b9c08eb0cbc3c6135c7e6f202c"
        ),
    )
...
def test_unfair_fee(client):
    ...
    payment_req = make_payment_request(
        ...
        outputs=outputs,
        hash_outputs=bytes.fromhex(
            "1c8fe26d350bf3b9def9e644e11afa82949ca178cacc60b41e1a1f8e040e80e3"
        ),
    )
...
def test_no_anonymity(client):
    ...
    payment_req = make_payment_request(
        ...
        outputs=outputs,
        hash_outputs=bytes.fromhex(
            "aa630c6b773cea473ab58b7a1a7d08c0a019e2732a5e00283b06fd92b92f7235"
        ),
    )

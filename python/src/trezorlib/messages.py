...
class TxAckPaymentRequest(protobuf.MessageType):
    ...
    FIELDS = {
        1: protobuf.Field("recipient_name", "string", repeated=False, required=True),
        ...
        4: protobuf.Field("nonce", "bytes", repeated=False, required=False),
